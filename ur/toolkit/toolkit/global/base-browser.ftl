new-identity-dialog-never-ask-checkbox =
    .label = مجھ سے دوبارہ نہ پوچھیں
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-label = بحال کریں
# Preferences - Letterboxing.
letterboxing-learn-more = اورجانیے
# Preferences - Letterboxing.
letterboxing-alignment-top = اوپر
# Security level popup panel.
security-level-panel-level-standard = سٹینڈرڈ
# Security level popup panel.
...
security-level-panel-custom-badge = كسٹم
# Custom security level.
# Some custom preferences configuration has placed the user outside one of the standard three levels.
...
basebrowser-addon-noscript-visibility-show = ظاہر کریں
# Option to show or hide the NoScript extension button/item.
basebrowser-addon-noscript-visibility-hide = چھپائیں
# Preferences - Letterboxing.
letterboxing-alignment-middle = درمیانی
# Security level popup panel.
security-level-panel-learn-more-link = اورجانیے
...
# Security level settings.
security-level-preferences-learn-more-link = اورجانیے
...
# Shown in the security level panel and settings.
security-level-restore-defaults-button = طے شدہ بحال کریں
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-ak = R
dropped-support-notification-dismiss-button = سمجھ گیے
