...
basebrowser-rfp-restore-window-size-button-label = रिस्टोर गर्नुहोस्
# Preferences - Letterboxing.
letterboxing-learn-more = अझै जानौ
# Preferences - Letterboxing.
letterboxing-alignment-top = माथि
...
security-level-panel-level-standard = स्टान्डर्ड
# Security level popup panel.
security-level-panel-level-safer = Safer
# Security level popup panel.
security-level-panel-level-safest = Safest
# Security level popup panel.
security-level-panel-learn-more-link = अझै जानौ
...
# Security level settings.
security-level-preferences-learn-more-link = अझै जानौ
...
security-level-panel-custom-badge = अनुकूल गर्नुहोस्
# Custom security level.
# Some custom preferences configuration has placed the user outside one of the standard three levels.
...
# Shown in the security level panel and settings.
security-level-restore-defaults-button = फेरी पहिलाकै अवस्था मा लैजाऊ ।
# Option to show or hide the NoScript extension button/item.
basebrowser-addon-noscript-visibility-hide = लुकाउनुहोस्
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-ak = R
# Option to show or hide the NoScript extension button/item.
basebrowser-addon-noscript-visibility-show = देखाउनुहोस्
dropped-support-notification-dismiss-button = बुझे
