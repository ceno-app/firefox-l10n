...
security-level-panel-learn-more-link = Daha ətraflı öyrən
security-level-preferences-heading = Təhlükəsizlik səviyyəsi
security-level-preferences-learn-more-link = Daha ətraflı öyrən
...
security-level-panel-custom-badge = Fərdi
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-label = Bərpa et
# Preferences - Letterboxing.
letterboxing-learn-more = Daha ətraflı öyrən
...
basebrowser-addon-noscript-visibility-hide = Gizlət
# Preferences - Letterboxing.
letterboxing-alignment-top = Üst
...
# Shown in the security level panel and settings.
security-level-restore-defaults-button = Standartları qaytar
# Option to show or hide the NoScript extension button/item.
basebrowser-addon-noscript-visibility-show = Göstər
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-ak = R
# Preferences - Letterboxing.
letterboxing-alignment-middle = Orta
