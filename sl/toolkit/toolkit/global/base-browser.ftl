...
new-identity-dialog-title = Ponastaviti vašo identiteto?
new-identity-dialog-never-ask-checkbox =
    .label = Ne vprašaj me ponovno
new-identity-dialog-confirm =
    .label = Ponovno zaženi { -brand-short-name }
security-level-panel-level-standard = Standard
security-level-panel-learn-more-link = Več o tem
security-level-panel-open-settings-button = Nastavitve …
security-level-preferences-heading = Varnostni nivo
security-level-preferences-learn-more-link = Več o tem
security-level-preferences-level-standard =
    .label = Standard
security-level-summary-standard = All Tor Browser and website features are enabled.
security-level-panel-custom-badge = Prilagojeno
security-level-preferences-custom-heading = Konfigurirana raven varnosti po meri
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-ak = R
# Fullscreen/maximization notification shown when letterboxing is disabled
basebrowser-rfp-restore-window-size-button-label = Obnovi
...
letterboxing-learn-more = Več o tem
# Preferences - Letterboxing.
letterboxing-alignment-top = Zgoraj
# Preferences - Letterboxing.
letterboxing-alignment-middle = Srednje
...
# Shown in the security level panel and settings.
security-level-restore-defaults-button = Ponastavi na privzeto
# Option to show or hide the NoScript extension button/item.
basebrowser-addon-noscript-visibility-show = Pokaži
# Option to show or hide the NoScript extension button/item.
basebrowser-addon-noscript-visibility-hide = Skrij
dropped-support-notification-dismiss-button = Imam ga
